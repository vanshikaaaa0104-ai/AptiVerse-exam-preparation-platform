...
export const PRACTICE_QUESTIONS_DATABASE: PracticeQuestion[] = [
  ...
  },
  {
    ...
    subtopicSlug: "time-work",
    difficulty: "MEDIUM",
    prompt: "A can complete a project in 20 days and B can complete the same project in 30 days. If they work on alternate days, starting with A on Day 1, in how many days will the entire project be completed?",
    type: "MCQ",
    options: ["24 days", "20 days", "22 days", "26 days"],
    correctAnswer: "24 days",
    explanation: "Let Total Work = LCM(20, 30) = 60 units. Efficiency of A = 60/20 = 3 units/day; Efficiency of B = 60/30 = 2 units/day. In each 2-day cycle (Day 1: A, Day 2: B), work completed = 3 + 2 = 5 units. Total 2-day cycles required = 60 / 5 = 12 cycles. Total days = 12 × 2 = 24 days.",
    stepByStep: [
      "Step 1: Total Work = LCM(20, 30) = 60 units",
      "Step 2: A's daily efficiency = 60 / 20 = 3 units/day",
      "Step 3: B's daily efficiency = 60 / 30 = 2 units/day",
      "Step 4: Work completed in 1 alternating cycle (2 days) = 3 + 2 = 5 units",
      "Step 5: Cycles needed = 60 / 5 = 12 cycles",
      "Step 6: Total days = 12 cycles × 2 days/cycle = 24 days",
    ],
    shortcutTrick: "1 pair of days = 1/20 + 1/30 = 5/60 = 1/12 of the work. To reach 12/12 work takes exactly 12 pairs = 24 days.",
    commonTrap: "Multiplying cycles by 1 instead of 2 (each cycle comprises 2 days: A then B).",
  },

...
name: generate-code
description: >-
  Generate production-ready, modular, full-stack code strictly adhering to architecture blueprints, database schemas, and API contracts with zero placeholder comments.
---

...
name: deploy-app
description: >-
  Package and deploy applications using Docker, docker-compose, environment secrets orchestration (.env.example), database migrations, and health verification checks.
---
